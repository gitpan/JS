# This Makefile is for the JS::JS extension to perl.
#
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/JS/JS.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/JS
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/JS
...
TO_INST_PM = lib/JS/JS.pm

PM_TO_BLIB = lib/JS/JS.pm \
	blib/lib/JS/JS.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/JS/JS.pm $(INST_MAN3DIR)/JS::JS.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               JS-JS' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           The great new JS::JS!' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Juan Manuel Torres <juan-manuel.torres@univ-avignon.fr>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new JS::JS!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Juan Manuel Torres &lt;juan-manuel.torres@univ-avignon.fr&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/JS/JS.pm blib/lib/JS/JS.pm 
