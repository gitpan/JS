...
*AUTOLOAD = \&JS::Object::AUTOLOAD; # Need in 5.8
...
is wrapped I<by reference> as a instance of JS::Array.

For transparency, and if the C<AutoTie> context option is TRUE, they will be
C<tied> to a perl ARRAY and instead of the JS::Array object, the
...
If you need the underlaying JS::Array object, it can be obtained using
Perl's C<tied> operator.

  my $jsarray = tied @$arr;

In javascript all arrays are objects, so this class inherits all
JS::Object's features.
