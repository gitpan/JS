...
JS::Stash - Perl namespaces reflector for javascript.

=head1 DESCRIPTION

Every perl namespace when exposed to javascript either automatically or by the methods
of the  L<JS::Controller> perl class is represented by an instance of a
C<Stash>.
...
The value returned by L<JS::Controller/add> and C<Stash> instances
entering perl land are wrapped as C<JS::Stash> objects.
