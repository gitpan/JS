...
$JS::ClassMap{Script} = __PACKAGE__;
...
JS::Script - Encapsulates pre-compiled javascript code.
...
C<JS::Context> provides a mean of returning a pre-compiled script which
...
Compiles a script and returns a C<JS::Script>
