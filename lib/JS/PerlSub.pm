...
JS::PerlSub - Encapsulate a Perl CODE reference in javascript
...
When you invoke a C<PerlSub> from javascript, in most cases JS does the
...
C<PerlObject> JS's engine will push it in the arguments. This will make
...
magical variable L<JS/$This>.

Perl code not aware of being called from javascript see its arguments
unmodified. Perl code can have javascript's C<this> via $JS::This. And
everyone is happy.
