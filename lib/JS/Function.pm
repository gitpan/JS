...
JS::Function - Reference to a javascript Function
...
The basic way to invoke a JS::Function instance is with the
method L<JS::Context/call>.
...
but a JS::Function instance can hold a reference to an anonymous one:

    my $func2 = $ctx->eval(q{ function (a, b) { return a + b }; });
    $ctx->call($func2 => 5, 6);         # 11
    $ctx->call($func2 => "foo", "bar"); # 'foobar'

Instances of JS::Function implement a short cut to avoid such verbose
code:
...
This class inherits from JS::Object.
...
Returns the C<prototype> of the function as a JS::Object. Useful if the
...
when the JS::Function is seen as a L<JS::Object>
...
And inherit the overload C<%{}> from L<JS::Object/"OVERLOADED OPERATORS">.
