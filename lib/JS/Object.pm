...
sub __bind_to_stash {
	...
	$sigil eq '@' ? \@{$self} : do {
	my $closure = sub {
	    local $JS::This = $JS::This;
	    if(@_ && !$JS::This) {
		if($_[0] eq $package) {
		    $JS::This = $self->__context->get_controller
			->added($package);
		    shift;
	    ...
	    @_ = ($self->__context, $JS::This, $self, [@_]);
	    goto &JS::Context::jsc_call;
	};
...
package JS::XMLObject;
use overload '""' => sub { $_[0]->toXMLString };
@JS::XMLObject::ISA = qw(JS::Object);
...
JS::Object - Reference to a javascript Object
...
JS::Object instance wrapper, instead the JS::Object instance
...
You need to use:
    ...
    $func->call(...);              # $func isa L<JS::Function>

The automatic conversion of JS::Object instances into HASH references
can be controled per context, via the L<JS::Context/AutoTie> option.

When C<AutoTie> is TRUE, the default, and you obtained a HASH reference, but
you need the underlaying JS::Object instance, it can get it using
L<perlfunc/tied>.

    my $jsobj = tied %$obj;
    print ref $jsobj;		    # 'JS::Object'
...
instances of JS::Object only define a minimun of methods, all in
...
Returns a HASH reference, tied to the underlayin JS::Object.
...
JS::Object instance in a context that expect a HASH reference, the
operation just work.
