...
push @JS::Context::CARP_NOT, __PACKAGE__;
...
my %services = (
	...
	my $ctl = JS::Context->current->get_controller;
	if(defined $con) {
...
JS::Runtime::Stock - Plugin that install stock services for javascript side
...
See L<JS::Controller> and L<JS::Stash> for the details.
...
You should read the discussion on L<JS::Controller/install>.
