...
sub __new {
    ...
    # Must use basic JS::Object methods, isn't tie-able yet
...
sub new {
    ...
    JS::Context::current()->eval(qq{ new Error($parms); });
}
...
JS::Error - Encapsulates errors thrown from javascript
...
wrapped as an instance of JS::Error and stored in C<$@>.

What happens next depends on the value of the option L<JS::Context/RaiseExceptions>.
...
JS::Error inherits from L<JS::Object> so you use them as any other
javascript Object.

=head2 Constructor

In Perl you can create new JS::Error instances, usefull when you need to
throw an exception from a perl land function called from javascript:

    die(JS::Error->new('something fails'));
...
a new javascript C<Error> instance, wrap it in a JS::Error object and return it.
